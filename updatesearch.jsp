...
<body>
    <form action="CServlet/updatesearch" method="post"  enctype="multipart/form-data" >
	...
	<div class="container">
		<nav class="navbar navbar-default">
			<div class="navbar-header">
				...
				<h1><a  href="home.html">B&B Optics<span> Lab </span></a></h1>
			</div>
				<!-- top-nav -->
			...
			<li>
				<div class="figure"><br>
                                    <span><td></td></span> <img src="images/laboratory-services.jpg" alt="">
                                      <br>  <input type="file" name="file" style="height:30px;width:200px">
				</div>
				<div class="article">
					<p>
