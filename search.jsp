...
<body>
    <form action="CServlet/Add3" method="post"  enctype="multipart/form-data" >
	...
	<div class="container">
		<nav class="navbar navbar-default">
			<div class="navbar-header">
				...
				<h1><a  href="search.jsp">B&B Optics<span> Lab </span></a></h1>
			</div>
				<!-- top-nav -->
	...
	<div id="body">
            <h3>请输入你添加的页数为第<input type="text" name="username" style="height:40px;width:80px">页</h3>
		<ul>
				...
				<div class="figure"><br>
                                    <span><td></td></span> <img src="images/laboratory-services.jpg" alt="">
                                      <br> 
                                       ...
                                       <font size="4" color="red">上传图片<br><br><input type="file" name="file" style="height:30px;width:200px"></font>
