...
<body>
    <form action="CServlet/updateabout" method="post"  enctype="multipart/form-data">
	...
	<div class="container">
		...
		<div class="services-grids w3layouts">
			<div class="col-md-6 ser-right-page">
                ...
                </div><br> <font size="6" color="red">建议上传图片大小约为500x350：</font><br><br><input type="file" name="file" style="height:35px;width:200px">
			</div>
			...
			<div class="clearfix"></div>
                ...
                <br> <br> <br><br> 
                <font size="6" color="red">   <input type="submit" value="更新" ></font> 
	</div>
</div>
