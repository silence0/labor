...
<body>
    <form action="CServlet/Add41" method="post"  enctype="multipart/form-data" >
			...
			<div class="col-md-3 team-grid agile">
				<div class="team-img">
					<div class="view second-effect">
                        ...
                        <br>   
             <br> <font size="5" color="red">输入学生姓名 <input type="text" name="p1" style="height:40px;width:150px"></font>
         <br>
		<br> <font size="5" color="red">输入入学年份 <input type="text" name="p2" style="height:40px;width:150px"></font>		
                  <br>    
			...
			<tr>
				...
				<td height="45" align="center" valign="middle">
                                    ...
                                    <font size="5" color="red">上传图片,建议上传证件照：</font><br><br>
                                    <input type="file" name="file" style="height:30px;width:200px">
                                              <br><br><br>
					
                                           <font size="5" color="red"> 请上传你的简介文件，应为PDF格式</font>
                                          <br> <br> <br>
