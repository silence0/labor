...
<body>
    <form action="CServlet/Add4" method="post"  enctype="multipart/form-data" >
			...
			<div class="col-md-3 team-grid agile">
				<div class="team-img">
					<div class="view second-effect">
                        ...
                        <br>  <br> 
             <br> <font size="5" color="red">输入老师姓名:<input type="text" name="p1" style="height:40px;width:150px"></font>
			...
			<tr>
				...
				<td height="45" align="center" valign="middle">
                                    ...
                                    <input type="file" name="file" style="height:35px;width:200px">
                                          ...
                                          <br> <br> <br>
						<input type="file" name="file1" style="height:35px;width:200px">
