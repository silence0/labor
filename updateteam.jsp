...
<body>
    <form action="CServlet/updateteam" method="post"  enctype="multipart/form-data" >
			...
			<div class="col-md-3 team-grid agile">
				<div class="team-img">
					<div class="view second-effect">
                        ...
                        <br>  <br> 
             <br> <font size="6" color="red">输入老师姓名 <input type="text" name="p1" style="height:40px;width:150px"></font>
