...
<body>
    <form action="CServlet/Add3" method="post">
		...
		<nav class="navbar navbar-default">
			...
			<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
				<ul class="nav navbar-nav navbar-right">
					...
					<li><a href="search1.jsp" class="active" >研究领域</a></li>
	...
	<div id="body">
        ...
        int id=1;
              ...
              if(conn != null){   
                ...
                for(int a=0;a<20;a++){           
            String sql="select * from  search where username= "+id;  
        ...
        %>
                ...
                <li>
                               <div class="figure"><br>
					<span><td></td></span> 
                                    <img src="myfile/<%= rs.getString("p2") %>" width="200"height="200"  alt=" "/>
				</div>
				<div class="article">
     <p>	
        <%= rs.getString("p1") %>
