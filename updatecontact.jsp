...
<body>
    <form action="CServlet/newsupdate" method="post" enctype="multipart/form-data" >
	...
	<div class="container">
		...
		<div class="team-grids">
			...
			<div class="col-md-3 team-grid agile">
                        ...
                        <br>  <br> 
             <br> <font size="6" color="red">输入新闻标题 <input type="text" name="p1" style="height:40px;width:150px"></font>
         
				
                  <br> 
                     <br> <font size="5" color="red">输入新闻时间，格式为20180101 <input type="text" name="p2" style="height:40px;width:150px"></font>
			...
			<tr>
				...
				<td height="45" align="center" valign="middle">
                                   ...
                                   <br><br><br>
                                           ...
                                           <font size="6" color="red"> 请上传你的新闻文件，应为PDF格式</font>
                                          <br> <br> <br>
